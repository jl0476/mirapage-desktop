...
<style scoped>.webtoon-scroll{height:100%;overflow:auto;background:var(--color-bg)}.webtoon-strip{position:relative;margin:0 auto}.webtoon-item img{display:block;width:100%;height:100%;object-fit:contain}</style>
