...
export default {
  ...
  fileBrowser: {
    ...
    pickRootLocal: 'Local folder…',
    pickRootAccounts: 'Network accounts',
    pickRootNoAccounts: 'No network accounts yet (add one in Accounts)',
    setRootHere: 'Set current directory as root',
    up: 'Up',
    refresh: 'Refresh',
